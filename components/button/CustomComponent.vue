...
<template>
  <div
    as="button" :class="{ 'cursor-not-allowed hover:ring-0 bg-[#27803C]': loading }"
    class="box-border relative z-30 inline-flex items-center justify-center w-auto px-6 py-2 overflow-hidden font-normal text-white transition-all duration-300 bg-green-600 rounded-md cursor-pointer group hover:ring-1 hover:ring-green-500 ease focus:outline-none"
  >
    <span
