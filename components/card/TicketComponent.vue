    ...
    >
      <div class="flex items-center justify-between w-full">
        ...
        <div class="flex items-center space-x-3">
          <Icon :name="props.colorScheme?.icon" class="text-2xl" />
          ...
          <div class="flex w-full space-x-3">
            <div class="flex items-center">
              <svg
                ...
                class="iconify iconify--noto" preserveAspectRatio="xMidYMid meet" fill="#ffffff"
                :stroke="props.colorScheme?.svgBorder" stroke-width="6.4"
              >
      ...
      <div class="grid text-white place-items-center">
        <div class="flex items-center space-x-3">
          ...
          <div class="inline-block w-px h-4 bg-gray-300" role="separator" />
          <p class="flex items-center space-x-2 text-sm">
            <span class="text-gray-300">Hosted by VueJs Kenya</span>
            <img src="/logo.png" alt="VueJs Logo" class="w-6 bg-white h-6 rounded-sm md:h-4 md:w-4">
          </p>
        </div>
      </div>
    </div>
